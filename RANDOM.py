...
class Main:
	def __init__(self):
		...
		os.system("clear")
		print(logo)
		print(" [1] RANDOM CLONE PAK  M1")
		print(" [2] RANDOM CLONE BD  M1")
		print(" [3] Exit Programming\n")
		Ahsan =input(" Choose : ")
		if Ahsan in ["1", "01"]:
			Random()
		if Ahsan in ["2", "02"]:
...
def password1():
    ...
    print(f"")
    clear()
    print("          \x1b[97m[\033[37;41m  C O D E    M E N U   \033[0;m]")
    print("")
    linex()
    print("        \x1b[97m[\033[95;42mEXAMPLE :👇\033[0;m]")
    print("")
    print(" 0306 ,0300 ,0315 ,0333")
    print(" 0341 ,0342 ,0345 ,0349")
    print(" 0321 ,0316 ,0308 ,0309")
    print("")
    linex()
    print("\x1b[97m[\033[37;41mBEST CODE 0300 / 0302 / 0306 / 0349 /0315   \033[0;m]")
    print("")
    linex()
    code = input(' PUT CODE : ')
    os.system("clear")
